...
std::string name = skCrypt("HeyRbsh").decrypt(); // application name. right above the blurred text aka the secret on the licenses tab among other tabs
std::string ownerid = skCrypt("FVmABSDV0g").decrypt(); // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
std::string secret = skCrypt("d1ea1801e3c8b5ca85a08c1b6a8a74f4cfcc94c2aeeacfd66f30bf0c9b181776").decrypt(); // app secret, the blurred text on licenses tab and other tabs
